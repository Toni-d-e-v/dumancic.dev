...
const items: { href: string; label: string; path: React.ReactNode }[] = [
  {
    href: social.github,
    label: "GitHub",
    path: (
  ...
  },
  {
    ...
    label: "X",
    path: (
      <path d="M18.24 2.25h3.31l-7.23 8.26L22.85 21.75h-6.66l-5.22-6.82-5.97 6.82H1.69l7.73-8.84L1.25 2.25h6.83l4.71 6.23 5.45-6.23Zm-1.16 17.52h1.83L7.01 4.13H5.04L17.08 19.77Z" />
    ),
  },
];

export function SocialIcons({ color = "#fff" }: { color?: string }) {
  return (
